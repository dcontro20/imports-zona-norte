  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        <h2 style={{ color: "#e0e0ff", margin: 0, fontSize: 22 }}>📲 Mensaje WhatsApp</h2>
      ...
      <Card style={{ marginBottom: 14, background: "#0d0d1a", border: "1px solid #25d36644" }}>
      ...
      <Card>
        <div style={{
          whiteSpace: "pre-wrap", fontFamily: "monospace", fontSize: 13, color: "#c0c0e0",
          ...
          {message.split("\n").map((line, i) => {
            ...
            if (isBold) {
              ...
              return (
                <div key={i} style={{ color: isHeader ? "#a855f7" : "#e0e0ff" }}>
